...
📘 **Implementation of JPEG Image Compression using the Discrete Cosine Transform (DCT)**
...
|-------------|-------------|
| 📄 documentation/ | Project report in PDF format |
| 🖼 datasets/ | Benchmark grayscale images used for testing |
| 📦 output/ | Compressed images generated by the program |
| 🧮 dct.py | Manual implementation of 2D-DCT and IDCT |
| 📉 quantization.py | JPEG quantization and inverse quantization |
| 📊 metrics.py | MSE, PSNR, and compression ratio calculations |
| 📈 graphs.py | Histogram and performance visualizations |
| ⚙ jpeg_dct.py | Main application |
---
